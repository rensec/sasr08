...
This document was written as an [R Markdown](http://rmarkdown.rstudio.com) Notebook. If you are reading the html version of this, you can just keep reading, and if you want to run any of the code yourself, you need to copy and paste the code to your own R-script.
...
```{r}
BGAT1_GT0<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=0, Type="GT")
BGAT1_GT1<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=1, Type="GT")
BGAT1_GT2<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=2, Type="GT")
BGAT1_GT3<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=3, Type="GT")
BGAT1_GT4<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=4, Type="GT")
BGAT1_GT5<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=5, Type="GT")
BGAT1_GT6<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=6, Type="GT")
BGAT1_GT7<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=7, Type="GT")
BGAT1_GT8<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=8, Type="GT")
BGAT1_GT9<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=9, Type="GT")
BGAT1_GT10<-xDichotomize(Burkhardt_GovernmentAgency$AdviceGivingT1, Value=10, Type="GT")
