...
This tutorial demonstrates some data handling procedures for relational (social network) data. In particular, we'll learn: -     How to read network data from disk and convert them into a 'network object' that R can work with, using the common network-oriented packages `igraph`  and `network`;
