...
When we look at the indirect effects, we observe that an increase in household income and an increase in housing value in a neighboring neighborhood significantly reduce crime in the focal neighborhood. However, the indirect impact is not significant.
