...
***Note:***: the namespace `igraph::` is not necessary if you only have `igraph` loaded, but in the creation of the online version of this file, it was necessary to avod confusion with the `network` package. 
